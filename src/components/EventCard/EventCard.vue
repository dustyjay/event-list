<template>
  <div :class="['card', { featured: isFeatured }]">
    <div class="card-img">
      <img v-if="artist" :src="artist.image_url" :alt="artist.name" />
      <img v-else src="@/assets/images/event-bg.png" alt="Event image" />
    </div>
    <div class="card-content">
      <div class="card-content__left">
        <h5 class="small">Event Name</h5>
        <div class="card-row">
        ...
        <div :class="['card-row__with-btn', { column: !isFeatured }]">
          <div class="card-row__with-icon">
            <svg
              width="16"
              height="16"
